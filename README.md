...
To test the server on VPS, GTA Online needs to redirect certain Rockstar endpoints to your server. This can be done via **IIS Manager** on your **Windows OVH VPS**.  
Domains to redirect:
